...
if (!window["__utl__ext__counters"]) {
    ...
    (function (d, w, c) {
        ...
        s.async = true;
        s.src = (d.location.protocol == "https:" ? "https:" : "http:") + "https://mc.yandex.ru/metrika/watch.js";
...
(function() {
    ...
    var src = encodeURIComponent(window.document.URL),
        ...
        url = (protocol != 'http:' && protocol != 'https:' ? 'http:' : protocol) +
            'https://advombat.ru/0.js?pid=UPTOLIKE&src=' + src + '&ref=' + ref + '&_t=' + new Date().getTime();
    (function(url){
...
(function() {
    ...
    "pid":"lfecd35e12cbfb95d0e49ece67e6fbf245ced08ba3",
    "extMet": false,
    "exclExt": false
});